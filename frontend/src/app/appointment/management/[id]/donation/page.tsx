...
const DonatedSection = ({
    ...
    const { data: donation, isPending, error } = useDonation(appointmentId);
    const { data: donor } = useAccount(donorId);
                ...
                <CardContent className="py-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="text-center">
                            ...
                            <div className="text-slate-600">Donation Type</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold text-slate-900 mb-2">
                                {donation.amount}ml
                        ...
                        <div className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl p-6 border border-slate-200">
                            ...
                            <Alert className="mt-6 border-blue-200 bg-blue-50 rounded-xl">
                                ...
                                <AlertDescription className="text-blue-800">
                                    <span>
                                        {capitalCase(newBloodBag.component)} is
                                        expected to expire on{' '}
                                        <strong>
...
export default function AppointmentDonationPage() {
    ...
    return (
        <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
            ...
            {apt.status === 'donated' && (
                <DonatedSection donorId={apt.donor_id} appointmentId={apt.id} />
            )}
        </div>
    );
}
