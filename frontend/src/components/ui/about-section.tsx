...
export default function Component() {
    const features = [
        ...
        },
        {
            ...
            description:
                'Connect with a network of donors and recipients. Build a community that cares for each other.',
        ...
        },
        {
            ...
            description:
                'Emergency blood requests and donor matching available round the clock for critical situations.',
        ...
        },
        {
            ...
            title: 'Safe & Secure',
            description:
                'All donations follow strict medical protocols ensuring safety for both donors and recipients.',
        ...
        },
        {
            ...
            description:
                'Find nearby blood banks, donation centers, and track blood availability in real-time.',
        ...
        },
        {
            ...
            description:
                'Instant notifications for urgent blood requirements with quick donor mobilization system.',
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <motion.h2
                                ...
                                animate="animate"
                                className="text-4xl font-bold tracking-tighter sm:text-6xl text-zinc-950 bg-clip-text text-transparent"
                            >
                            ...
                            >
                                Our blood donation system bridges the gap
                                between generous donors and those in critical
                                need. Through technology and compassion, we make
                                blood donation accessible, efficient, and
                                life-saving.
                            </motion.p>
                        </div>
                    </motion.div>
                        ...
                        <Card className="max-w-5xl mx-auto bg-gradient-to-br from-red-900/30 via-purple-900/30 to-blue-900/30 border border-red-500/30 backdrop-blur-sm relative overflow-hidden">
                            ...
                            <CardContent className="p-10 relative z-10">
                                <motion.div className="flex items-center justify-center mb-6">
                                    ...
                                    >
                                        <Heart
                                            className="h-10 w-10 text-red-400 mr-4"
                                            fill="currentColor"
                                        />
                                    </motion.div>
                                ...
                                >
                                    ...
                                    donation can be the difference between life
                                    and death. Join thousands of heroes who have
                                    already made a commitment to save lives.
                                </motion.p>
